...
avg_full = pd.read_csv('cluster_output_data_2003.csv')
...
output_data_merge.to_csv(r'output_data_opted_2003.csv')
print("Data outputed in output_data_opted_2003.csv")
